...
function StartupSelect({ ...props }: React.ComponentProps<typeof SelectPrimitive.Root>) {
  return <SelectPrimitive.Root {...props} />;
}
function StartupSelectGroup({ ...props }: React.ComponentProps<typeof SelectPrimitive.Group>) {
  return <SelectPrimitive.Group {...props} />;
}
function StartupSelectValue({ ...props }: React.ComponentProps<typeof SelectPrimitive.Value>) {
  return <SelectPrimitive.Value {...props} />;
}
function StartupSelectTrigger({
  className,
  children,
  ...props
...
export {
  StartupSelect as Select,
  StartupSelectGroup as SelectGroup,
  StartupSelectValue as SelectValue,
  StartupSelectTrigger as SelectTrigger,
  StartupSelectContent as SelectContent,
  StartupSelectItem as SelectItem,
};
